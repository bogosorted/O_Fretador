...
public class GeraMapa : MonoBehaviour
{
    ...
    public static List<int> direcao = new List<int>();
    ...
    void Awake()
    {
        ...
        direcao.Add(1);// 0 == esq, 1 == frente, 2 == direi, 3 == baix
    ...
    {
        //var result = direcao[direcao.Count - 1] + Random.Range(-1, 2);
        direcao.Add(Random.Range(0, 3));
    }
}
